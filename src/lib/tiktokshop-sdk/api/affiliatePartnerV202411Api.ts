...
export class AffiliatePartnerV202411Api {
    ...
    /**
     * TAP can use this API to retrieve a list of affiliate orders and track the affiliate conversions. Note: This API will be depreciated on 2026.06.30, no data will be return after that.
